...
export default function MyRequestsPageRobust() {
  ...
  const fetchMyRequests = async () => {
    try {
      ...
      // ID del usuario de prueba - en producción vendría del contexto de auth
  ...
  // Configuraciones de estado - igual que en el portal principal
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl">
      {/* Header con estadísticas - estilo del portal */}
      <div className="mb-8">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-6">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Seguimiento completo de tus solicitudes de innovación
            </p>
          </div>
      ...
      {/* Tabs con conteo - estilo del portal */}
      <Tabs defaultValue="active" className="space-y-6">
        ...
        <TabsContent value="active">
          <RequestsList requests={grouped.active} type="active" />
        </TabsContent>

        <TabsContent value="completed">
          <RequestsList requests={grouped.completed} type="completed" />
        </TabsContent>

        <TabsContent value="onHold">
          <RequestsList requests={grouped.onHold} type="onHold" />
        </TabsContent>
      </Tabs>
    </div>
  )
...
function RequestsList({ requests, type }: { requests: Request[], type: string }) {
  if (requests.length === 0) {
    const messages = {
      active: "No tienes solicitudes activas en este momento",
      completed: "No tienes solicitudes finalizadas aún", 
...
// Componente de tarjeta de solicitud - estilo del portal
    ...
    <Card className="shadow-sm hover:shadow-md transition-all duration-200 border-l-4 border-l-blue-500">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 capitalize">{request.classification || 'No definido'}</p>
            </div>
          </div>
        ...
        {request.platforms && request.platforms.length > 0 && (
          <div>
            <h4 className="font-semibold text-sm text-gray-700 dark:text-gray-300 mb-3">Plataformas involucradas:</h4>
        ...
        {/* Progreso si está en evaluación */}
        {request.status === 'in_evaluation' && (
          <div className="bg-orange-50 dark:bg-orange-950/50 rounded-lg p-4">
            <h4 className="font-semibold text-sm text-orange-800 dark:text-orange-200 mb-3">
        ...
        {request.technical_analysis && Object.keys(request.technical_analysis).length > 0 && (
          <div className="bg-purple-50 dark:bg-purple-950/50 rounded-lg p-4">
            ...
            <p className="text-sm text-purple-700 dark:text-purple-300">
              Se ha realizado el análisis técnico de tu solicitud. Los resultados están disponibles para revisión del líder.
            </p>
          </div>
        )}
      </CardContent>
...
// Funciones auxiliares (deben estar fuera del componente)
